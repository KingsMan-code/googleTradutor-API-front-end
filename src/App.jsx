    ...
    <div className='min-h-screen bg-background flex flex-col'>
      <header className='bg-white shadow-sm'>
        <div className='max-w-5xl mx-auto px-4 py-3 flex items-center'>
          ...
          <h1 className='text-headerColor text-2xl font-bold'>Hello World</h1>
        </div>
      </header>
      ...
      <main className='flex-grow flex items-start justify-center px-4 py-8'>
        <div className='w-full max-w-5xl bg-white rounder-lg shadow-md overflow-hidden'>
          ...
          {error && <div>
            <p className='p-4 bg-red-100 border-t border-red-400 text-red-700'>{error}</p>
          </div>}
      ...
      <footer className='bg-white border-t border-gray-200 mt-auto'>
        <div className='max-w-5xl mx-auto px-4 py-3 text-sm text-headerColor font-bold'>&copy; {new Date().getFullYear()} Tradutor DevClub</div>
      </footer>
    </div>
  )
}
